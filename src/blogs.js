export const my_blogs = {
    ...
    "blog_2":{
        ...
        "author":"rahul3d2y",
        "date":"2023-01-24",
        "content":"I started using stackup last year around October .The first quest i successfully submitted was 'introduction to database in 'MySQL'. Since then I have participated in 57 quests and was able to earn around 160 dollars P.S 'thank u stackup for this opportunity '.This platform have not only provided us with the brief knowledge into various field of computer science but also provided us a was of income .that really helps and provide a sense of fulfilment into its users ",
      },
  }